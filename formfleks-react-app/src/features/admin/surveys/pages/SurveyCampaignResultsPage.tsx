...
interface CampaignResults {
    ...
    totalParticipants: number; totalResponses: number; responseRate: number; currentUserAccessLevel: number;
...
const TextAnswersPanel = ({ campaignId, question, isAnonymous, currentUserAccessLevel }: { campaignId: string; question: QuestionStats; isAnonymous: boolean; currentUserAccessLevel: number }) => {
    ...
    const showPrivacyWarning = isAnonymous || currentUserAccessLevel < 2;
...
export const SurveyCampaignResultsPage = () => {
    ...
    const showYanitGezgini = !results.isAnonymous && results.currentUserAccessLevel >= 2;
