...
export interface FfTagBoxProps extends React.ComponentProps<typeof TagBox> {
  label?: string;
  error?: string;
  helperText?: string;
  required?: boolean;
...
export const FfTagBox = React.forwardRef<TagBox, FfTagBoxProps>(
