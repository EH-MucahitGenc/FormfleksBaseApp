...
public interface IEmailService
{
    ...
    Task SendDraftReassignedEmailAsync(string toEmail, string assigneeName, string formRequestNo, Guid formRequestId, string formTypeName, string assignerName, string requesterCompany, CancellationToken cancellationToken = default);
