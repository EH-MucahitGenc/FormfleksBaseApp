...
namespace FormfleksBaseApp.Infrastructure.Migrations.DynamicFormsDb
{
    ...
    [Migration("20260512084509_AddHrAuthorizations")]
    partial class AddHrAuthorizations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FormfleksBaseApp.Domain.Entities.Admin.HrAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsGlobalManager");

                    b.HasIndex("LocationName", "Active");

                    b.HasIndex("UserId", "Active");

                    b.ToTable("hr_authorizations", (string)null);
                });
